...
<body class="vertical-layout vertical-compact-menu 1-column menu-expanded fixed-navbar" data-open="click" data-menu="vertical-compact-menu" data-col="1-column" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 100vh;">
        ...
        <div class="content-wrapper">
            <div class="container">
                ...
                <div class="table-container">
                    <h3>✅ المسابقات المرفوعة ({{ $uploadedCount }})</h3>
                    @if(count($uploaded) > 0)
                                ...
                                <tbody>
                                    @foreach($uploaded as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item['subject'] }}</td>
                                            <td>{{ $item['division'] }}</td>
                                            <td><span class="badge badge-success">✓ مرفوع</span></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                ...
                @if(count($competitions) > 0)
                    <div class="table-container">
                        <h3>📋 تفاصيل المسابقات المرفوعة</h3>
                        <div style="overflow-x: auto;">
                            <table>
                                <thead>
                                    <tr>
