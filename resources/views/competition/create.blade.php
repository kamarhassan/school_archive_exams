...
<head>
    ...
    <meta name="description"
        content="متوسطة سحمر الاولى الرسمية مسابقات اخر السنة">
    <meta name="keywords"
        content="admin template, modern admin template, dashboard template, flat admin template, responsive admin template, web app, crypto dashboard, bitcoin dashboard">
    <meta name="author" content="PIXINVENT">
    <title>متوسطة سحمر الاولى الرسمية</title>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/app-assets/vendors/css/forms/spinner/jquery.bootstrap-touchspin.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/app-assets/vendors/css/forms/icheck/icheck.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/app-assets/vendors/css/forms/toggle/bootstrap-switch.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/app-assets/vendors/css/forms/toggle/switchery.min.css') }}">

    <style>
        /* Ensure long brand text wraps and stays centered */
        .brand-text {
            white-space: normal;
...
<body class="vertical-layout vertical-compact-menu 1-column   menu-expanded fixed-navbar" data-open="click"
        ...
        <div class="navbar-wrapper">
                  <li class="nav-item">
                        <a class="navbar-brand">
                            <h3 class="brand-text">متوسطة سحمرالاولى الرسمية مسابقات الفصل الاخير 2025-2026</h3>
                        </a>
                    </li>
    ...
    <footer class="footer footer-static footer-dark navbar-border navbar-shadow">
        <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span
                class="float-md-left d-block d-md-inline-block">Copyright &copy; 2026 <a
                    class="text-bold-800 grey darken-2" target="_blank">Developed By HASSAN KAMAR
                </a>, All rights reserved. </span><span
                class="float-md-right d-block d-md-inline-blockd-none d-lg-block">
            </span></p>
    </footer>

    <!-- BEGIN VENDOR JS-->
    <script src="{{ asset('assets/app-assets/js/core/libraries/jquery.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/app-assets/vendors/js/ui/popper.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/app-assets/js/core/libraries/bootstrap.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/app-assets/vendors/js/ui/perfect-scrollbar.jquery.min.js') }}" type="text/javascript">
    </script>
    ...
    <script src="{{ asset('assets/app-assets/vendors/js/ui/jquery-sliding-menu.js') }}" type="text/javascript"></script>
